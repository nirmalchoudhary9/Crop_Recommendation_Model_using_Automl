...
data_sample = PandasParameterType(pd.DataFrame({"N": pd.Series([0], dtype="int64"), "P": pd.Series([0], dtype="int64"), "K": pd.Series([0], dtype="int64"), "temperature": pd.Series([0.0], dtype="float64"), "humidity": pd.Series([0.0], dtype="float64"), "ph": pd.Series([0.0], dtype="float64"), "rainfall": pd.Series([0.0], dtype="float64")}))
